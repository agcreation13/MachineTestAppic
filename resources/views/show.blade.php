        ...
        <div class="table-responsive" id="pagination-demo">
            <table class="table table-bordered text-center">
                <thead>
                    <tr>
                        <td colspan="3">
                            <form action="{{ url('products/searching') }}" method="get" class="d-flex" role="search">
                                <input class="form-control me-2" name="q" type="search" placeholder="Search"
                                    aria-label="Search"><button class="btn btn-outline-success"
                                    type="submit">Search</button>
                            </form>
                        </td>
                        <td colspan="4"><a href="{{ url('/') }}" class="btn btn-outline-secondary">Show All</a>
                        </td>
                        <td>
                ...
                <tbody>
                    @if (count($productslist) < 1)
                        <tr>
                            <td colspan="8"><span class="text-danger fw-bold">No data found</span></td>
                        </tr>
                    @else
